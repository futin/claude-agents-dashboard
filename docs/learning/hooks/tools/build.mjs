/**
 * build.mjs — generate docs/learning/hooks/index.html from the markdown.
 *
 * The markdown is canonical. Run this after editing it:
 *   node docs/learning/hooks/tools/build.mjs
 *
...
<div class="shell">
  ...
  <main id="top">
    ...
    are. Generated from the markdown in <code>docs/learning/hooks/README.md</code> +
    <code>docs/learning/hooks/guide/</code> by <code>docs/learning/hooks/tools/build.mjs</code>
