 ...
 * over docs/published-guides/ that builds the GuidesIndex behind
 ...
 * for the parsing half: every file under docs/published-guides/ is
 ...
 * request and the rest of the repository (docs/published-guides/ sits right
